...
// Nombre max de Queens en top/bottom par défaut, tant que l'admin n'a rien configuré
// (voir ConfigData.maxTopBottom / ResultData.maxTopBottom).
export const DEFAULT_MAX_TOP_BOTTOM = 3;